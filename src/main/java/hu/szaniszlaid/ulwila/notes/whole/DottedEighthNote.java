...
public class DottedEighthNote extends MusicNote {
	...
	public void drawNote(Graphics2D g) {
		// 8th part
		g.setColor(getColor());
		Arc2D quarter = new Arc2D.Double(0, 0, QUARTER_NOTE_WIDTH, QUARTER_NOTE_HEIGHT, 90, 180, Arc2D.OPEN);
		g.fill(quarter);
		...
		// 16th part
		g.setColor(getColor());
		g.fillRect(QUARTER_NOTE_WIDTH / 2, 0, rectWidth, QUARTER_NOTE_HEIGHT);
		g.setColor(Color.BLACK);
		g.drawRect(QUARTER_NOTE_WIDTH / 2, 0, rectWidth, QUARTER_NOTE_HEIGHT);
	}
