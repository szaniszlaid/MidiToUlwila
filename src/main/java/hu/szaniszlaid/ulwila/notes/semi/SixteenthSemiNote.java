...
public class SixteenthSemiNote extends SixteenthNote {
	...
	public void drawNote(Graphics2D g) {
		...
		g.fillRect(MARGIN_HORIZONTAL, MARGIN_VERTICAL, SIXTEENTH_WIDTH / 2, QUARTER_NOTE_HEIGHT);
		g.setColor(Color.BLACK);
		g.drawRect(MARGIN_HORIZONTAL, MARGIN_VERTICAL, SIXTEENTH_WIDTH / 2, QUARTER_NOTE_HEIGHT);

		g.setColor(getRightColor());
		g.fillRect(SIXTEENTH_WIDTH / 2 + MARGIN_HORIZONTAL, MARGIN_VERTICAL, SIXTEENTH_WIDTH / 2, QUARTER_NOTE_HEIGHT);
		g.setColor(Color.BLACK);
		g.drawRect(SIXTEENTH_WIDTH / 2 + MARGIN_HORIZONTAL, MARGIN_VERTICAL, SIXTEENTH_WIDTH / 2, QUARTER_NOTE_HEIGHT);
	}
