...
public class DottedEighthSemiNote extends DottedEighthNote {
	...
	public void drawNote(Graphics2D g) {
		...
		//16th part
		int sixteenthLeftX = QUARTER_NOTE_WIDTH / 2 + MARGIN_LEFT;
		g.setColor(getLeftColor());
		g.fillRect(sixteenthLeftX, MARGIN_TOP, SIXTEENTH_WIDTH / 2, QUARTER_NOTE_HEIGHT);
		g.setColor(Color.BLACK);
		g.drawRect(sixteenthLeftX, MARGIN_TOP, SIXTEENTH_WIDTH / 2, QUARTER_NOTE_HEIGHT);

		int sixteenthRightX = QUARTER_NOTE_WIDTH / 2 + MARGIN_LEFT + SIXTEENTH_WIDTH / 2;
		g.setColor(getRightColor());
		g.fillRect(sixteenthRightX, MARGIN_TOP, SIXTEENTH_WIDTH / 2, QUARTER_NOTE_HEIGHT);
		g.setColor(Color.BLACK);
		g.drawRect(sixteenthRightX, MARGIN_TOP, SIXTEENTH_WIDTH / 2, QUARTER_NOTE_HEIGHT);
	}
