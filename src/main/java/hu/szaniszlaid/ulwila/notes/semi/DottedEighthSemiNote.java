...
public class DottedEighthSemiNote extends DottedEighthNote {
	...
	public void drawNote(Graphics2D g) {
		...
		// 16th part
		int sixteenthLeftX = QUARTER_NOTE_WIDTH / 2;
		g.setColor(getLeftColor());
		g.fillRect(sixteenthLeftX, 0, SIXTEENTH_WIDTH / 2, QUARTER_NOTE_HEIGHT);
		g.setColor(Color.BLACK);
		g.drawRect(sixteenthLeftX, 0, SIXTEENTH_WIDTH / 2, QUARTER_NOTE_HEIGHT);

		int sixteenthRightX = QUARTER_NOTE_WIDTH / 2 + SIXTEENTH_WIDTH / 2;
		g.setColor(getRightColor());
		g.fillRect(sixteenthRightX, 0, SIXTEENTH_WIDTH / 2, QUARTER_NOTE_HEIGHT);
		g.setColor(Color.BLACK);
		g.drawRect(sixteenthRightX, 0, SIXTEENTH_WIDTH / 2, QUARTER_NOTE_HEIGHT);
	}
